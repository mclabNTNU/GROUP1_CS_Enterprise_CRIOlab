...
# define ctrl_student_HIL_old_P        ctrl_student_HIL_old_P DataSection(".NIVS.defaultparams")
#endif

/*
 * ctrl_student_HIL_old_data.c
 *
...
P_ctrl_student_HIL_old_T ctrl_student_HIL_old_P = {
...
NI_ParamSizeWidth P_ctrl_student_HIL_old_T_sizes[] DataSection(
  ".NIVS.defaultparamsizes") = {
  { sizeof(P_ctrl_student_HIL_old_T), 1 },

...
#
# File    : u2pwm.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           		:= u2pwm
MODULES         		:= NIVeriStand_main.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c u2pwm_data.c 
MAKEFILE        		:= u2pwm.mk
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\MCLab\DOCUME~1\GitHub\GROUP1~1\SIMULI~1\u2pwm_niVeriStand_VxWorks_rtw

 ...
 * C source code generated on : Thu Mar 30 07:18:24 2017
 *
...
{
  { 0, "u2pwm/BT_min_pwm", 0, "", offsetof(B_u2pwm_T, BT_min_pwm)+0*sizeof
    (real_T), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 1, "u2pwm/BT_max_pwm", 0, "", offsetof(B_u2pwm_T, BT_max_pwm)+0*sizeof
...
{
  { 0, "BT_min_pwm", 0, EXT_IN, 1, 1, 1 },

  { 1, "BT_max_pwm", 0, EXT_IN, 1, 1, 1 },
...
static char* NI_CompiledModelDateTime = "Thu Mar 30 07:18:24 2017";

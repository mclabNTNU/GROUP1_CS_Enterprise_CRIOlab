...
#
# File    : ctrl_sixaxis2force.mk (for Release 2007b and later)
#
# Abstract:
...
MODULES         		:= NIVeriStand_main.c ctrl_sixaxis2force_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
MAKEFILE        		:= ctrl_sixaxis2force.mk
...
MODELLIB                  := ctrl_sixaxis2forcelib.lib
MODELREF_LINK_LIBS   	  := 
MODELREF_INC_PATH         := 
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\MCLab\DOCUME~1\GitHub\GROUP1~1\SIMULI~1\ctrl_sixaxis2force_niVeriStand_VxWorks_rtw

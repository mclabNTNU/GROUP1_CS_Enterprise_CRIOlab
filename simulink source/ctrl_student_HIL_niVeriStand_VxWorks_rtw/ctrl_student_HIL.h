...
/* Block signals for system '<S20>/MATLAB Function' */
typedef struct {
  real_T y[9];                         /* '<S20>/MATLAB Function' */
...
typedef struct {
  ...
  real_T Sum[3];                       /* '<S2>/Sum' */
  real_T Memory4[3];                   /* '<S3>/Memory4' */
  real_T Memory5[3];                   /* '<S3>/Memory5' */
  real_T Memory2;                      /* '<S3>/Memory2' */
  real_T Sum_g;                        /* '<S3>/Sum' */
  real_T Integrator1_e;                /* '<S3>/Integrator1' */
  real_T invM[3];                      /* '<S2>/inv(M)' */
  real_T Memory3[3];                   /* '<S3>/Memory3' */
  ...
  B_MATLABFunction_ctrl_student_T sf_MATLABFunction_h;/* '<S21>/MATLAB Function' */
  B_MATLABFunction_ctrl_student_T sf_MATLABFunction_a;/* '<S20>/MATLAB Function' */
...
typedef struct {
  ...
  real_T Memory_PreviousInput_p[10];   /* '<S7>/Memory' */
  real_T Memory1_PreviousInput[10];    /* '<S7>/Memory1' */
  real_T x_bar_DWORK1;                 /* '<S24>/x_bar' */
  real_T y_bar_DWORK1;                 /* '<S24>/y_bar' */
  real_T psi_bar_DWORK1;               /* '<S24>/psi_bar' */
  real_T psi_hat_DWORK1;               /* '<S25>/psi_hat' */
  real_T x_hat_DWORK1;                 /* '<S25>/x_hat' */
  real_T y_hat_DWORK1;                 /* '<S25>/y_hat' */
  real_T r_hat_DWORK1;                 /* '<S26>/r_hat' */
  real_T u_hat_DWORK1;                 /* '<S26>/u_hat' */
  real_T v_hat_DWORK1;                 /* '<S26>/v_hat' */
  real_T L12_DWORK1;                   /* '<S20>/L12' */
  real_T L11_DWORK1;                   /* '<S20>/L11' */
  real_T L13_DWORK1;                   /* '<S20>/L13' */
  real_T L21_DWORK1;                   /* '<S21>/L21' */
  real_T L22_DWORK1;                   /* '<S21>/L22' */
  real_T L23_DWORK1;                   /* '<S21>/L23' */
  real_T L31_DWORK1;                   /* '<S22>/L31' */
  real_T L32_DWORK1;                   /* '<S22>/L32' */
  real_T L33_DWORK1;                   /* '<S22>/L33' */
  real_T Memory4_PreviousInput[3];     /* '<S3>/Memory4' */
  real_T Memory5_PreviousInput[3];     /* '<S3>/Memory5' */
  real_T Memory2_PreviousInput;        /* '<S3>/Memory2' */
  real_T psi_noise_DWORK1;             /* '<S5>/psi_noise' */
  real_T x_noise_DWORK1;               /* '<S5>/x_noise' */
  real_T y_noise_DWORK1;               /* '<S5>/y_noise' */
  ...
  uint8_T u_BT_DWORK2[17];             /* '<S6>/u_BT' */
  uint8_T u_VSP1_DWORK2[17];           /* '<S6>/u_VSP1' */
  uint8_T u_VSP2_DWORK2[17];           /* '<S6>/u_VSP2' */
  uint8_T alpha_VSP1_DWORK2[17];       /* '<S6>/alpha_VSP1' */
  uint8_T alpha_VSP2_DWORK2[17];       /* '<S6>/alpha_VSP2' */
  uint8_T PosXLeft_DWORK2[17];         /* '<S6>/PosXLeft' */
  uint8_T omega_VSP1_DWORK2[17];       /* '<S6>/omega_VSP1' */
  uint8_T PosYLeft_DWORK2[17];         /* '<S6>/PosYLeft' */
  uint8_T omega_VSP2_DWORK2[17];       /* '<S6>/omega_VSP2' */
  ...
  uint8_T dead_DWORK2[17];             /* '<S4>/dead' */
  uint8_T Enable_noise_DWORK2[17];     /* '<Root>/Enable_noise' */
  uint8_T x_bar_DWORK2[17];            /* '<S24>/x_bar' */
  uint8_T y_bar_DWORK2[17];            /* '<S24>/y_bar' */
  uint8_T psi_bar_DWORK2[17];          /* '<S24>/psi_bar' */
  uint8_T psi_hat_DWORK2[17];          /* '<S25>/psi_hat' */
  uint8_T x_hat_DWORK2[17];            /* '<S25>/x_hat' */
  uint8_T y_hat_DWORK2[17];            /* '<S25>/y_hat' */
  uint8_T r_hat_DWORK2[17];            /* '<S26>/r_hat' */
  uint8_T u_hat_DWORK2[17];            /* '<S26>/u_hat' */
  uint8_T v_hat_DWORK2[17];            /* '<S26>/v_hat' */
  uint8_T L12_DWORK2[17];              /* '<S20>/L12' */
  uint8_T L11_DWORK2[17];              /* '<S20>/L11' */
  uint8_T L13_DWORK2[17];              /* '<S20>/L13' */
  uint8_T L21_DWORK2[17];              /* '<S21>/L21' */
  uint8_T L22_DWORK2[17];              /* '<S21>/L22' */
  uint8_T L23_DWORK2[17];              /* '<S21>/L23' */
  uint8_T L31_DWORK2[17];              /* '<S22>/L31' */
  uint8_T L32_DWORK2[17];              /* '<S22>/L32' */
  uint8_T L33_DWORK2[17];              /* '<S22>/L33' */
  uint8_T psi_noise_DWORK2[17];        /* '<S5>/psi_noise' */
  uint8_T x_noise_DWORK2[17];          /* '<S5>/x_noise' */
  uint8_T y_noise_DWORK2[17];          /* '<S5>/y_noise' */
...
typedef struct {
  ...
  ZCSigState Integrator1_Reset_ZCE_h;  /* '<S3>/Integrator1' */
 ...
 * '<S3>'   : 'ctrl_student_HIL/case D'
 * '<S4>'   : 'ctrl_student_HIL/dead rec  switch'
 * '<S5>'   : 'ctrl_student_HIL/eta_noise_ut'
 * '<S6>'   : 'ctrl_student_HIL/joystick'
 * '<S7>'   : 'ctrl_student_HIL/signal dropout check '
 * '<S8>'   : 'ctrl_student_HIL/signal switch '
 ...
 * '<S19>'  : 'ctrl_student_HIL/Observer/D'
 * '<S20>'  : 'ctrl_student_HIL/Observer/L1'
 * '<S21>'  : 'ctrl_student_HIL/Observer/L2'
 * '<S22>'  : 'ctrl_student_HIL/Observer/L3'
 * '<S23>'  : 'ctrl_student_HIL/Observer/Rotation matrix'
 * '<S24>'  : 'ctrl_student_HIL/Observer/eta_bar_ut'
 * '<S25>'  : 'ctrl_student_HIL/Observer/eta_hat_ut'
 * '<S26>'  : 'ctrl_student_HIL/Observer/nu_hat_ut'
 * '<S27>'  : 'ctrl_student_HIL/Observer/L1/MATLAB Function'
 * '<S28>'  : 'ctrl_student_HIL/Observer/L2/MATLAB Function'
 * '<S29>'  : 'ctrl_student_HIL/Observer/L3/MATLAB Function'
 * '<S30>'  : 'ctrl_student_HIL/case D/Ellipsoidal path'
 * '<S31>'  : 'ctrl_student_HIL/case D/Straight -line '
 * '<S32>'  : 'ctrl_student_HIL/case D/controller'
 * '<S33>'  : 'ctrl_student_HIL/case D/inputs'
 * '<S34>'  : 'ctrl_student_HIL/case D/signal switch '
 * '<S35>'  : 'ctrl_student_HIL/case D/update law'
 * '<S36>'  : 'ctrl_student_HIL/case D/z1//z2'
 * '<S37>'  : 'ctrl_student_HIL/joystick/MATLAB Function'
 * '<S38>'  : 'ctrl_student_HIL/joystick/Thrust allocation'
 * '<S39>'  : 'ctrl_student_HIL/signal dropout check /MATLAB Function'
 * '<S40>'  : 'ctrl_student_HIL/switch/Switch_function'
 */

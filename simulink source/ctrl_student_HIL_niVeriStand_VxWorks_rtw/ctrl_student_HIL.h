...
typedef struct {
  real_T y[9];                         /* '<S21>/MATLAB Function' */
...
typedef struct {
  ...
  real_T WhiteNoise_e;                 /* '<S19>/White Noise' */
  real_T WhiteNoise_m;                 /* '<S17>/White Noise' */
  ...
  B_MATLABFunction_ctrl_student_T sf_MATLABFunction_h;/* '<S22>/MATLAB Function' */
  B_MATLABFunction_ctrl_student_T sf_MATLABFunction_a;/* '<S21>/MATLAB Function' */
...
typedef struct {
  ...
  real_T NextOutput_c;                 /* '<S19>/White Noise' */
  real_T NextOutput_p;                 /* '<S17>/White Noise' */
  ...
  real_T x_bar_DWORK1;                 /* '<S25>/x_bar' */
  real_T y_bar_DWORK1;                 /* '<S25>/y_bar' */
  real_T psi_bar_DWORK1;               /* '<S25>/psi_bar' */
  real_T psi_hat_DWORK1;               /* '<S26>/psi_hat' */
  real_T x_hat_DWORK1;                 /* '<S26>/x_hat' */
  real_T y_hat_DWORK1;                 /* '<S26>/y_hat' */
  real_T r_hat_DWORK1;                 /* '<S27>/r_hat' */
  real_T u_hat_DWORK1;                 /* '<S27>/u_hat' */
  real_T v_hat_DWORK1;                 /* '<S27>/v_hat' */
  real_T L12_DWORK1;                   /* '<S21>/L12' */
  real_T L11_DWORK1;                   /* '<S21>/L11' */
  real_T L13_DWORK1;                   /* '<S21>/L13' */
  real_T L21_DWORK1;                   /* '<S22>/L21' */
  real_T L22_DWORK1;                   /* '<S22>/L22' */
  real_T L23_DWORK1;                   /* '<S22>/L23' */
  ...
  uint32_T RandSeed_j;                 /* '<S19>/White Noise' */
  uint32_T RandSeed_c;                 /* '<S17>/White Noise' */
  ...
  uint8_T x_bar_DWORK2[17];            /* '<S25>/x_bar' */
  uint8_T y_bar_DWORK2[17];            /* '<S25>/y_bar' */
  uint8_T psi_bar_DWORK2[17];          /* '<S25>/psi_bar' */
  uint8_T psi_hat_DWORK2[17];          /* '<S26>/psi_hat' */
  uint8_T x_hat_DWORK2[17];            /* '<S26>/x_hat' */
  uint8_T y_hat_DWORK2[17];            /* '<S26>/y_hat' */
  uint8_T r_hat_DWORK2[17];            /* '<S27>/r_hat' */
  uint8_T u_hat_DWORK2[17];            /* '<S27>/u_hat' */
  uint8_T v_hat_DWORK2[17];            /* '<S27>/v_hat' */
  uint8_T L12_DWORK2[17];              /* '<S21>/L12' */
  uint8_T L11_DWORK2[17];              /* '<S21>/L11' */
  uint8_T L13_DWORK2[17];              /* '<S21>/L13' */
  uint8_T L21_DWORK2[17];              /* '<S22>/L21' */
  uint8_T L22_DWORK2[17];              /* '<S22>/L22' */
  uint8_T L23_DWORK2[17];              /* '<S22>/L23' */
  uint8_T L31_DWORK2[17];              /* '<S23>/L31' */
  uint8_T L32_DWORK2[17];              /* '<S23>/L32' */
  uint8_T L33_DWORK2[17];              /* '<S23>/L33' */
...
typedef struct {
  ...
  ZCSigState Integrator1_Reset_ZCE_h;  /* '<S4>/Integrator1' */
...
struct P_ctrl_student_HIL_T_ {
  ...
  real_T Memory_X0;                    /* Expression: 3
                                        ...
                                        */
  real_T sw_P1;                        /* Expression: width
                                        * Referenced by: '<Root>/sw'
                                        */
  real_T sw_P2;                        /* Expression: dtype
                                        * Referenced by: '<Root>/sw'
                                        */
  real_T sw_P3;                        /* Expression: portnum
                                        * Referenced by: '<Root>/sw'
                                        */
  real_T sw_P4;                        /* Expression: stime
                                        * Referenced by: '<Root>/sw'
                                        */
  real_T sw_P5;                        /* Expression: stype
                                        * Referenced by: '<Root>/sw'
                                        */
  real_T sw_P6;                        /* Expression: btype
                                        * Referenced by: '<Root>/sw'
                                        */
  ...
  real_T Constant6_Value[2];           /* Expression: [0;0]
                                        ...
                                        */
  real_T Constant1_Value_k[2];         /* Expression: [10;4]
  ...
  real_T Constant3_Value[2];           /* Expression: [0;0]
                                        ...
                                        */
  real_T Constant4_Value[2];           /* Expression: [1;1]
 ...
 * '<S3>'   : 'ctrl_student_HIL/Subsystem'
 * '<S4>'   : 'ctrl_student_HIL/case D'
 ...
 * '<S9>'   : 'ctrl_student_HIL/signal switch '
 * '<S10>'  : 'ctrl_student_HIL/switch'
 ...
 * '<S20>'  : 'ctrl_student_HIL/Observer/D'
 * '<S21>'  : 'ctrl_student_HIL/Observer/L1'
 * '<S22>'  : 'ctrl_student_HIL/Observer/L2'
 * '<S23>'  : 'ctrl_student_HIL/Observer/L3'
 * '<S24>'  : 'ctrl_student_HIL/Observer/Rotation matrix'
 * '<S25>'  : 'ctrl_student_HIL/Observer/eta_bar_ut'
 * '<S26>'  : 'ctrl_student_HIL/Observer/eta_hat_ut'
 * '<S27>'  : 'ctrl_student_HIL/Observer/nu_hat_ut'
 * '<S28>'  : 'ctrl_student_HIL/Observer/L1/MATLAB Function'
 * '<S29>'  : 'ctrl_student_HIL/Observer/L2/MATLAB Function'
 * '<S30>'  : 'ctrl_student_HIL/Observer/L3/MATLAB Function'
 * '<S31>'  : 'ctrl_student_HIL/Subsystem/MATLAB Function'
 * '<S32>'  : 'ctrl_student_HIL/case D/Ellipsoidal path'
 * '<S33>'  : 'ctrl_student_HIL/case D/Straight -line '
 ...
 * '<S41>'  : 'ctrl_student_HIL/switch/Switch_function'
 */
